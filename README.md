...
# Overview
My personal [Home Assistant](https://home-assistant.io) configuration.  These are the active automations and configurations that I use every day.
...
| [PETKIT Dishwasher Safe Cat Water Fountain](https://a.co/d/1u3YzVW) | 1 | Wi-Fi | [homeassistant_petkit](https://github.com/Jezza34000/homeassistant_petkit/)| Smart automatic cat drinking fountain with motion sensor. |
| [PETKIT Automatic Cat Feeder with Camera](https://a.co/d/g39QA4y) | 1 | Wi-Fi | [homeassistant_petkit](https://github.com/Jezza34000/homeassistant_petkit/)| Smart automatic cat feeder with camera. |
...
| [EcoSmart LED Light Bulbs 60-Watt ](https://www.homedepot.com/p/EcoSmart-60-Watt-Equivalent-Smart-A19-Color-Changing-CEC-LED-Light-Bulb-with-Voice-Control-1-Bulb-Powered-by-Hubspace-12A19060WRGBWH1/322660146) | 14 | Hubspace | [Hubspace](https://github.com/jdeath/Hubspace-Homeassistant) | Smart A19 Color Changing CEC LED Light Bulbs. |
...
| Device  | Quantity | Connection | Home Assistant | Notes |
| :-------------: | :---: | :-------------: | :-------------: | :-------------: |
| [Geeni Dot Smart Wi-Fi Outlet Plug](https://a.co/d/8JaNTos) | 3 | Wi-Fi | [Tuya](https://www.home-assistant.io/integrations/tuya/) | Wi-Fi Smart outlets utilized to control various devices.  These are slowly being phased out. |
| [THIRDREALITY ZigBee Smart Plug](https://a.co/d/8JaNTos) | 12 | Zigbee2MQTT | [Zigbee2MQTT](https://www.home-assistant.io/integrations/mqtt/) | Smart outlets are utilized to control various devices by powering the outlet on/off.  These devices feature real-time energy monitoring and are Zigbee repeaters. |
...
| [SONOFF ZigBee Motion Sensor](https://a.co/d/dklTW3n) | 3 | Zigbee2MQTT | [Zigbee2MQTT](https://www.home-assistant.io/integrations/mqtt/) | Motion sensors are used to automate Lights when motion is sensed. |
...
| [THIRDREALITY Zigbee Vibration Sensor](https://a.co/d/8NfjLfm) | 3 | Zigbee2MQTT | [Zigbee2MQTT](https://www.home-assistant.io/integrations/mqtt/) | Vibration sensors are used to assist in automations around the house. |
| [THIRDREALITY ZigBee Temperature and Humidity Sensor](https://a.co/d/6TgAEhs) | 3 | Zigbee2MQTT | [Zigbee2MQTT](https://www.home-assistant.io/integrations/mqtt/) | Monitor my home’s temperature and humidity. |
| [THIRDREALITY ZigBee Smart Soil Moisture Sensor](https://a.co/d/bSafccN) | 1 | Zigbee2MQTT | [Zigbee2MQTT](https://www.home-assistant.io/integrations/mqtt/) | Monitor my cactus's soil humidity. |
...
## <a name="vacuum">Vacuums</a>

| [Menu](#menu) 

| Device  | Quantity | Connection | Home Assistant | Notes |
| :-------------: | :---: | :-------------: | :-------------: | :-------------: |
| [Shark RV1100A](https://a.co/d/ehNCmZ7) | 1 | Wi-Fi | [Shark IQ](https://www.home-assistant.io/integrations/sharkIQ)| Automated to run at specific times. Shark has changed their API system, and have since broke HA intergration. |
...
| Device  | Quantity | Connection | Home Assistant | Notes |
| :-------------: | :---: | :-------------: | :-------------: | :-----------------------------------: |
| [Amazon Echo Dot](https://amzn.to/2wSreSW) | 3 | Wi-Fi | [Home Assistant Cloud](https://www.home-assistant.io/cloud/) | Audio only Voice Assistant. |
